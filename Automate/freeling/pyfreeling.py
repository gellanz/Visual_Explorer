...
class status(_object):
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["stat"] = _pyfreeling.status_stat_set
    __swig_getmethods__["stat"] = _pyfreeling.status_stat_get
    if _newclass:
        stat = _swig_property(_pyfreeling.status_stat_get, _pyfreeling.status_stat_set)
    __swig_setmethods__["description"] = _pyfreeling.status_description_set
    __swig_getmethods__["description"] = _pyfreeling.status_description_get
    if _newclass:
        description = _swig_property(_pyfreeling.status_description_get, _pyfreeling.status_description_set)

    def __init__(self):
        this = _pyfreeling.new_status()
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    __del__ = lambda self: None
status_swigregister = _pyfreeling.status_swigregister
status_swigregister(status)

class analyzer_config(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, analyzer_config, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, analyzer_config, name)
    __repr__ = _swig_repr
    __swig_setmethods__["config_opt"] = _pyfreeling.analyzer_config_config_opt_set
    __swig_getmethods__["config_opt"] = _pyfreeling.analyzer_config_config_opt_get
    if _newclass:
        config_opt = _swig_property(_pyfreeling.analyzer_config_config_opt_get, _pyfreeling.analyzer_config_config_opt_set)
    __swig_setmethods__["invoke_opt"] = _pyfreeling.analyzer_config_invoke_opt_set
    __swig_getmethods__["invoke_opt"] = _pyfreeling.analyzer_config_invoke_opt_get
    if _newclass:
        invoke_opt = _swig_property(_pyfreeling.analyzer_config_invoke_opt_get, _pyfreeling.analyzer_config_invoke_opt_set)

    def __init__(self):
        this = _pyfreeling.new_analyzer_config()
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
...
analyzer_config_swigregister = _pyfreeling.analyzer_config_swigregister
analyzer_config_swigregister(analyzer_config)
